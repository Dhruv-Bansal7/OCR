...
// import { ActivityIndicator, PermissionsAndroid, Platform, View , Text , NativeModules} from "react-native";
// import TesseractOcr , { LANG_ENGLISH , INIT_DEFAULTS} from 'react-native-tesseract-ocr'
...
//                 console.log("Trained data download sucessfully");
//                 return true;
//             }
//             else {
//                 throw new Error('Downlaod failed with status : ' + response.statusCode);
//             }
//         } catch( err) {
//             setIsDownloading(false);
...
//     const  prepareTessDataDir = async () => {
//         const tessDataDir = RNFS.DocumentDirectoryPath + '/tesseract' + '/tessdata';
//         const trainedDataPath = `${tessDataDir}/eng.traineddata`;

//         try {
//             const dirExists = await RNFS.exists(tessDataDir);
//             if(!dirExists) {
//                 await RNFS.mkdir(tessDataDir);
//             }

//             const fileExists = await RNFS.exists(trainedDataPath);
//             if(!fileExists){
//                 const assetPath = Platform.OS === 'android' ? 'file://android_assest/tessdata/eng.traineddata' : RNFS.MainBundlePath + '/tessdata/eng.traineddata';
                
//                 try {
//                     await RNFS.copyFile(assetPath , trainedDataPath);
//                     console.log("Trained data copy from assests");
//                 }
//                 catch (copyerr) {
//                     console.log('No Trained data in assests , downloading from internet...');
//                     await downloadTrainedData(trainedDataPath);
//                     console.log('Trained data download successfully');
//                 }

//             } else {
//                 console.log('Trained data file already exists');
//             }
//             return tessDataDir;
//         } catch (err) {
//             console.log('Error preparing tessdata dir : ', err);
//             throw err;
//         }
//     };

//     const createTempDirectory = async () => {
//         const tessDataPath = `${RNFS.ExternalDirectoryPath}/tesseract/tessdata`;
//         console.log("Creaeting directr at : " , tessDataPath)
//         try {
//             // Check if directory exists
//             const exists = await RNFS.exists(tessDataPath);
//             if (!exists) {
...
//             console.log('Tess : ' , TesseractOcr)
//             console.log('RNFS : ' , RNFS)

//             const tessDataPath = await prepareTessDataDir();
//             await createTempDirectory()
//             console.log("Temp Directry : " , tessDataPath);
//             // await copyTessDataFiles();

//             const result = await RNTesseractOcr.recognize(imagePath, 'eng' ,{
//                 whitelist : null,
//                 blacklist : null,
//             });
        ...
        try {
            ...
            const granted = await PermissionsAndroid.request(
                PermissionsAndroid.PERMISSIONS.WRITE_EXTERNAL_STORAGE,
                {
                    ...
                    message: "App needs storage permission for OCR",
                    buttonNeutral: "Ask Me Later",
                    buttonNegative: "Cancel",
                    buttonPositive: "OK"
                }
            ...
            if (granted === PermissionsAndroid.RESULTS.GRANTED) {
                ...
                console.log("Never ask again selected");
                Alert.alert(
                    'Permission Required',
                    'Please enable storage permission from settings to use OCR',
                    [
                        { text: 'Cancel', style: 'cancel' },
